...
local SCRIPT_NAME = "Twisted Fate"

---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------

local SOURCELIB_URL = "https://raw.github.com/LegendBot/Scripts/master/Common/SourceLib.lua"
...
if AUTOUPDATE then
	 SourceUpdater(SCRIPT_NAME, version, "raw.github.com", "/LegendBot/Honda7-Mirror/master/"..SCRIPT_NAME..".lua", SCRIPT_PATH .. GetCurrentEnv().FILE_NAME, "/LegendBot/Honda7-Mirror/master/Versions/"..SCRIPT_NAME..".version"):CheckUpdate()
end
